-- LitoColor ERP — v21: permite borrar registros de producción
--
-- La tabla "produccion" ya tenía políticas RLS de SELECT/INSERT/UPDATE
-- (ver schema.sql y ajustes_v3_correcciones.sql), pero nunca de DELETE.
-- Sin esto, el botón "Eliminar" del panel Operario (solo visible para
-- Admin/Gerente/Jefe de Producción, ver js/auth.js puedeEditarProduccion)
-- fallaría al intentar borrar un registro duplicado o erróneo.
--
